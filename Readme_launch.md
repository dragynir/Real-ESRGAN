...
CUDA_VISIBLE_DEVICES=1 python inference_realesrgan.py -n RealESRGAN_x4plus -i datasets/real/rgb/glass/1x -o predictions/real/glass/1x --model_path experiments/train_gan_real_exp0/models/net_g_85000.pth
